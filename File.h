...
private:
    ...
    list<Record> myRecs;
    //	int numRecs;
    // records the size of page when storing in bits (not in the TWList)
    int curSizeInBytes;
...
private:
    ...
    int myFilDes;
    // current # of pages in the file including the first page and empty ones
    off_t curLength;
...
public:
    ...
    // TODO
    bool RemovePageHead (Record *, off_t);
    ...
    // and any other file located at that location is erased.
    // Otherwise, the file is simply opened
